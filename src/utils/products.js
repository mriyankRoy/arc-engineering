export const products = [
  /* --------------------------------------------------------------------------
     NEW CATEGORY 1 — CUSTOM ACOUSTIC & WEATHERPROOF ENCLOSURE
  --------------------------------------------------------------------------- */
  {
    category: "Custom Acoustic & Weatherproof Enclosure",
    slug: "custom-acoustic-enclosures",
    type: "direct",
    ...
    description:
      "High-performance sound-attenuated and weatherproof housing for critical power infrastructure.",
    items: [
      {
        id: "AGP-CONT-DC-CUSTOM",
        name: "Custom Acoustic & Weatherproof Enclosure",
  ...
  /* --------------------------------------------------------------------------
     NEW CATEGORY 2 — MODULAR E-HOUSE & E-POD SOLUTIONS
  --------------------------------------------------------------------------- */
  {
    category: "Modular E-House & E-POD Solutions",
    slug: "modular-e-house",
    type: "direct",
    ...
    description:
      "Complete, plug-and-play power distribution centers for remote and demanding locations.",
    items: [
      {
  ...
  /* --------------------------------------------------------------------------
     NEW CATEGORY 3 — PUMP SKIDS & CHEMICAL INJECTION PACKAGES
  --------------------------------------------------------------------------- */
  {
    category: "Pump Skids & Chemical Injection Packages",
    slug: "pump-skids-injection",
    type: "direct",
    ...
    description:
      "Precision fluid delivery and well intervention solutions for the global energy sector.",
    items: [
      {
        id: "AGP-PUMP-SKID-003",
        name: "Pump Skids & Chemical Injection Packages",
  ...
  /* --------------------------------------------------------------------------
     NEW CATEGORY 4 — SELF-BUNDED FUEL STORAGE
  --------------------------------------------------------------------------- */
  {
    category: "Self-Bunded Fuel Storage",
    ...
    description:
      "Premium Acecube 110% self-bunded tanks for safe, compliant fuel storage and transport.",
    items: [
      {
        id: "AGP-FUEL-ACECUBE-004",
        name: "Self-Bunded Fuel Storage",
  ...
  /* --------------------------------------------------------------------------
     5. TOP LEVEL CARD — GENERATOR ACCESSORIES (The "Hub" Category)
  --------------------------------------------------------------------------- */
  {
    category: "Generator Accessries",
    slug: "generator-accessories",
    type: "parent", // Tells the UI to show Sub-Category cards first
    categoryId: "CAT-GEN-ACC",
    image: {
      url: "https://res.cloudinary.com/dc912sjxj/image/upload/v1767795636/AGP_Generator_Enclosures_Pump_Skids_E-House_E-POD_zp5f8n.webp",
      alt: "Generator Accessories Hub",
    },
    description:
      "Access our full range of specialized generator components and tools.",

    // These will be your 4 "Inner" Cards
    subCategories: [
      {
        name: "Instrument & Generator Package Accessories",
        ...
        items: [
          {
            ...
            details: {
              ...
              Accuracy: "±0.5% F.S.",
              Materials:
                "316L Stainless Steel, PA6 Polyamide, FEP Cable Sheath",
          ...
          },
          {
            ...
            details: {
              ...
              DataLogging:
                "300 Event Capacity (Alarms, Faults & Interventions)",
              UserInterface:
          ...
          },
          {
            ...
            details: {
              ...
              CompatibleFluids:
                "Diesel, HVO, Kerosene, Water, Waste Oil, AdBlue®",
              Calibration:
                "Simple keypad setup for tank dimensions and density",
      ...
      {
        name: "Electrical Items and Accessories",
      ...
      {
        name: "Mechanical Items and Accessories",
        ...
        items: [
          ...
          },
          {
            ...
            details: {
              ...
              SwitchOrientation:
                "User Specified: 'Make on Rise' or 'Make on Fall'",
              InstallationLimits:
          ...
          },
          {
            ...
            details: {
              Material:
                "Pre-Galvanised M.S. to BS EN 10346 2015 DX51D [cite: 32]",
              BladeType:
              ...
              Maintenance:
                "Accessible mechanism for easy maintenance [cite: 13]",
            },
          },
          {
            id: "EAT-MOT-DAMP-002",
  ...
  /* --------------------------------------------------------------------------
     CATEGORY 2 — INSTRUMENT & GENERATOR PACKAGE ACCESSORIES
  --------------------------------------------------------------------------- */
  // {
  ...
  // /* --------------------------------------------------------------------------
  //    CATEGORY 3 — ELECTRICAL ITEMS AND ACCESSORIES
  // --------------------------------------------------------------------------- */
  // {
  ...
  // /* --------------------------------------------------------------------------
  //    CATEGORY 4 — MECHANICAL ITEMS AND ACCESSORIES
  // --------------------------------------------------------------------------- */
  // {
