    ...
    <div className="relative flex items-center">
      ...
      <div className="relative w-full">
        <input
          ...
          className="
            pl-4 pr-10 py-1.5 
            bg-white/90 text-sm text-gray-800 
            rounded-full border border-white/20 shadow-sm 
            focus:outline-none focus:ring-2 focus:ring-[#BF092F] 
            transition-all 
            /* RESPONSIVE WIDTHS */
            w-32           /* Tiny on very small mobile */
            xs:w-40        /* Small mobile */
            sm:w-48        /* Tablets */
            md:w-56        /* Small Laptops */
            lg:w-150        /* Desktops */
          "
          value={query}
        ...
        {/* RESULTS DROPDOWN */}
        {results.length > 0 && (
          <ul className="absolute z-[120] w-full bg-white shadow-2xl rounded-2xl mt-2 max-h-60 overflow-auto border border-gray-100">
