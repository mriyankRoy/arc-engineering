...
export default function SkillsShowcase() {
  ...
  const renderTab = (skill, actualIndex) => (
    ...
    >
      ...
      <div className={`w-1.5 h-1.5 rounded-full transition-all ${selected === actualIndex ? "bg-[#BF092F] scale-125" : "bg-white/10"}`} aria-hidden="true" />
    ...
    >
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "description": "BS EN compliant engineering proficiency across UK-standard design and manufacturing.",
          "hasOfferCatalog": {
            "@type": "OfferCatalog",
      ...
      {/* BACKGROUND DECOR */}
      <div className="absolute top-10 right-[-5%] md:right-[-2%] text-[8rem] sm:text-[12rem] md:text-[15rem] font-black text-gray-50 select-none pointer-events-none tracking-tighter uppercase leading-none z-0" aria-hidden="true">
        TECH
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <header className="flex flex-col md:flex-row md:items-end justify-between mb-12 md:mb-20 gap-8">
          <div style={reveal(hasRevealed)}>
            <div className="flex items-center gap-3 mb-4">
              ...
              <p className="text-[10px] tracking-[0.4em] text-[#BF092F] font-bold uppercase">Technical Capabilities</p>
            </div>
          ...
          <div className="max-w-sm" style={reveal(hasRevealed, "200ms")}>
            <p className="text-xs sm:text-sm text-gray-400 uppercase tracking-widest leading-relaxed border-l border-gray-100 pl-6 py-1">
              BS EN compliant engineering proficiency across UK-standard design, precision manufacturing, and mission-critical systems.
            </p>
          </div>
        </header>

        {/* MOBILE NAVIGATION */}
        <nav className="lg:hidden flex overflow-x-auto pb-6 mb-4 gap-2 scrollbar-hide snap-x" aria-label="Technical modules">
        ...
        <article className="grid grid-cols-1 lg:grid-cols-12 shadow-2xl rounded-2xl md:rounded-[2.5rem] overflow-hidden border border-gray-100 bg-[#44444E]" style={reveal(hasRevealed, "400ms")}>
          ...
          {/* LEFT TERMINAL */}
          <aside className="hidden lg:flex lg:col-span-3 bg-[#44444E] flex-col border-r border-white/5 h-full" role="tablist" aria-orientation="vertical">
          ...
          {/* RIGHT TERMINAL */}
          <aside className="hidden lg:flex lg:col-span-3 bg-[#44444E] flex-col h-full" role="tablist" aria-orientation="vertical">
            <div className="p-6 border-b border-white/10 bg-black/10">
