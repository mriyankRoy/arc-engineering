...
const ProductScope = () => {
  ...
  return (
    ...
    >
      {/* BACKGROUND DECOR: Ghost "SCOPE" aligned to Right for consistency */}
      <div 
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* TOP HEADER: Precisely matched to CorporateProfile & HybridModel */}
        ...
        {/* PRODUCT GALLERY: Optimized Grid */}
        <div 
        ...
        {/* FOOTER CTA: Matches the component rhythm */}
        <footer 
        ...
        >
          <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#BF092F]">Quality Assurance</p>
              <p className="text-sm text-gray-500 max-w-sm">All strategic products are manufactured to ISO 9001 and British engineering standards.</p>
            </div>
          </div>
