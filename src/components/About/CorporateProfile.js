    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between mb-16 md:mb-20 gap-8">
          ...
          <div className="max-w-sm" style={reveal(hasRevealed, "200ms")}>
            <p className="text-xs sm:text-sm text-gray-400 uppercase tracking-widest leading-relaxed border-l border-gray-100 pl-6 py-1">
              Strategic manufacturing operations providing UK-standard
              engineering with global scale for European and worldwide power
              requirements.
            </p>
          </div>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <ShieldCheck
                  ...
                  aria-hidden="true"
                />
                <h3 className="text-xl md:text-2xl font-bold text-[#44444E]">
                  UK Standards, Global Delivery
                </h3>
              </div>
              ...
              <div className="space-y-4 text-gray-600">
                ...
                <p className="text-sm leading-relaxed text-gray-500">
                  Our expertise covers specialized industrial tanks, reservoirs,
                  and precision metal containers, ensuring all units meet the
                  stringent compliance required for UK and EU power projects.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-3" role="list">
              {[
                ...
                <div
                  key={i}
                  role="listitem"
                  className="flex items-center gap-3 px-4 py-3 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#BF092F]/20 transition-all"
                >
                  <span className="text-[#BF092F]">{sector.icon}</span>
                  <span className="text-[10px] font-black text-[#44444E] uppercase tracking-widest">
                    {sector.label}
                  </span>
                </div>
              ))}
          ...
          {/* RIGHT: IMAGERY */}
          <div
            className="lg:col-span-7 grid grid-cols-1 md:grid-cols-12 gap-4 order-1 lg:order-2"
          ...
          >
            <figure className="md:col-span-8 overflow-hidden rounded-3xl shadow-xl relative group h-[280px] sm:h-[350px] md:h-[450px]">
              <img
                src="https://media.arcengltd.com/facility-images/Hamriyah_Facility_03.webp"
              ...
              <figcaption className="absolute bottom-4 left-4 right-4 p-4 md:p-6 bg-white/95 backdrop-blur-sm rounded-2xl flex items-center justify-between border border-white/20">
                <div>
                  <p className="text-[9px] font-bold text-[#BF092F] uppercase tracking-[0.2em]">
                    Global Scale
                  </p>
                  <p className="text-xs md:text-sm font-bold text-[#44444E]">
            ...
            <div className="hidden md:flex md:col-span-4 flex-col gap-4">
              <figure className="h-[210px] rounded-3xl overflow-hidden shadow-lg border-2 border-white">
                <img
                  src="https://media.arcengltd.com/cdn-cgi/image/width=1200,format=auto,quality=auto/project-images/ARC_Project_Sajja_PowerPack_04.webp"
        ...
        {/* FOOTER CTA */}
        <footer
          className="mt-16 md:mt-24 p-6 md:p-10 bg-gray-50 rounded-[2rem] border border-gray-100 flex flex-col lg:flex-row items-center justify-between gap-8"
          style={reveal(hasRevealed, "800ms")}
        >
          <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
            ...
            <div>
              <h4 className="text-lg md:text-xl font-bold text-[#44444E]">
                Engineering Specifications
              </h4>
              <p className="text-xs text-gray-400 max-w-sm">
                Review our compliance frameworks and technical standards for UK
